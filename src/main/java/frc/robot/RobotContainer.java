...
public class RobotContainer {
    ...
    private double Speed = MaxSpeed / 4; 
    ...
    private void configureBindings() {
        ...
        drive.withVelocityX(-joystick.getLeftY() * Speed) // Drive forward with negative Y (forward)
            .withVelocityY(-joystick.getLeftX() * Speed) // Drive left with negative X (left)
